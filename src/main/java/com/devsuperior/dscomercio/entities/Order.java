...
public class Order {
	...
	/*
	 * um pedido tem que ter um usuario ou seja o usuario pode ter varios pedidos
	 * (lado do muitos)
	 */
	@ManyToOne
	...
	/*
	 * um pedido pode ter um payment ou não ou seja se eu excluir um pedido não faz
	 * sentido ter um payment
	 */
