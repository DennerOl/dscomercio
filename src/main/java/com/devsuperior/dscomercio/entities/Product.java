...
// mudei o padrão para text	
	...
	/*
	 * relacionamento muito para muitos com a category ou seja um produto tem uma
	 * colecao de categoria criado com set, pois não quero que repita o id na
