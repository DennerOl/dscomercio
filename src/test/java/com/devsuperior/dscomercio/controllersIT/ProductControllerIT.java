...
public class ProductControllerIT {
	...
	void setUp() throws Exception {
		...
		product = new Product(null, "Play5", "Video game de geração top", 3999.90, "https://raw.githubusercontent.com/devsuperior/dscatalog-resources/master/backend/img/1-big.jpg");
	...
	public void insertShouldReturnProductDTOCreatedWhenAdminLogged() throws Exception {
		...
		result.andExpect(jsonPath("$.description").value("Play5"));
